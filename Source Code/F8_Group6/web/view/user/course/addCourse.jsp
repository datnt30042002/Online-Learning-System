                        ...
                        <div class="d-md-flex justify-content-between">
                            <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    <li class="breadcrumb-item"><h5 style="color: orangered ; font-family: inherit">Thêm khóa học mới</h5></li>
                                </ul>
                            </nav>
                            <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mt-4">
                                <div class="card border-0 p-4 rounded shadow">
                                    <form action="addCourse" method="POST" class="mt-4">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <c:forEach items="${listUser}" var="user">
                                                        <c:if test="${user.getUserID() == admin.getUserID()}">
                                                            ...
                                                            <input type="text" value="${admin.getFullName()}" class="form-control" readonly="">
                                                        </c:if>
                                                    </c:forEach>     
                                                </div>
                                            </div><!--end col-->
