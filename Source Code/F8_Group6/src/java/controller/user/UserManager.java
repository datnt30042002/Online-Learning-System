...
import controller.course.AddCourse;
import dao.UserDAO;
import dto.User;
import dto.UserRole;
...
public class UserManager extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<UserRole> listUserRole = udao.getAllUserRole();
            request.setAttribute("listUserRole", listUserRole);
            // Số người dùng trên mỗi trang
            int pageSize = 10;
            // Tổng số trang
            int totalPages = (int) Math.ceil((double) listUser.size() / pageSize);
            ...
            List<User> listUserByPage = listUser.subList(start, end);
