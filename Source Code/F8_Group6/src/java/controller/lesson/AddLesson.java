...
public class AddLesson extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.addLesson(LessonID, LessonName, CourseID);
            
            
            request.setAttribute("messSuccess", "Add new Lesson success");
            
            request.getRequestDispatcher("view/user/lesson/addLesson.jsp").forward(request, response);
        } catch (SQLException ex) {
            Logger.getLogger(AddLesson.class.getName()).log(Level.SEVERE, null, ex);
        }
